...
// Grouped gallery data: each event/section has a title, date, and an array of images (only src and caption)
const gallerySections = [
  {
    ...
    images: [
      ...
      },
      {
        ...
        caption: "Coding Competition Winners",
      },
      {
        src: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80",
        caption: "Night Performance",
      },
    ],
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Relive the best moments from our events. Add new event images
            anytime—just update the gallerySections list!
          </p>
        </div>
            ...
            <div key={sectionIdx}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-4">
                {section.images.map((img, imgIdx) => (
                  <div
                    key={imgIdx}
                    className="group rounded-2xl overflow-hidden bg-white shadow hover:shadow-lg transition-all cursor-pointer flex flex-col"
                    onClick={() =>
                      setSelectedImage({
                        ...img,
                  ...
                  >
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                      <h3 className="font-semibold text-sm mb-1 line-clamp-1 text-center">
                        {img.caption}
                      </h3>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="flex items-center justify-between text-sm text-muted-foreground">
                  <span>{selectedImage.sectionTitle}</span>
                  <span>
